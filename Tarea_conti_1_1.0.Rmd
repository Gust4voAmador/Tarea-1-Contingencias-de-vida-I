...
library(readxl)
Male <- read_excel("/Users/sofiabocker/Desktop/universidad/UCR/Actuariales/Cuarto año/I Ciclo/Contingencias de Vida I/tarea_contingencias/Tarea-1-Contingencias-de-vida-I/Male.xlsx")
View(Male)
```
...
library(readxl)
Female <- read_excel("/Users/sofiabocker/Desktop/universidad/UCR/Actuariales/Cuarto año/I Ciclo//Contingencias de Vida I/tarea_contingencias/Tarea-1-Contingencias-de-vida-I/Female.xlsx")
View(Female)
